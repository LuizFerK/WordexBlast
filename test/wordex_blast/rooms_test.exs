defmodule WordexBlast.RoomsTest do
  ...
  describe "rooms" do
    ...
    import WordexBlast.RoomsFixtures

    @invalid_attrs %{is_private: nil, language: nil}
    ...
    test "create_room/1 with valid data creates a room" do
      valid_attrs = %{is_private: true, language: "some language"}
    ...
    test "update_room/2 with valid data updates the room" do
      room = room_fixture()
      update_attrs = %{is_private: false, language: "some updated language"}
